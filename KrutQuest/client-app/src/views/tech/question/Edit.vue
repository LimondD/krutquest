<template>
  <div class="question-edit-view border border-top-0 p-3">
    <h2>Изменить</h2>
    <br />
...
<script>
  ...
  export default {
    ...
    mounted: function () {
      ...
      this.loadLookups()
        .then(() => {
          return api.question.getById(questionId);
        })
        .then(question => {          
          vm.form.text = question.text
          vm.form.groupId = question.groupId
          vm.form.answers = question.answers
          vm.form.score = question.score
          vm.form.hint = question.hint
          vm.form.pictureId = question.pictureId
        })
